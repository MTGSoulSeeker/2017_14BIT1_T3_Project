...
<?php
        ...
        $sqli = "select * from product where name LIKE '%".$searchdata."%'";
        ...
        {
          $sqli2 = "select * from product_img where product_id=$data[id]";
 ...
 ?>
                ...
                <div class="pages">
                    <ul class="pagination">
                        ...
                        <?php
                          $sqli3 = "select count(id) as total from product where name LIKE '%".$searchdata."%'";
