...
<div class="navbar navbar-default yamm" role="navigation" id="navbar">
    <div class="container">
                            ...
                            <div class="yamm-content">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <h5>Clothing</h5>
                                        <ul>
                                            <li><a href="category.php?page=1">T-shirts</a>
                                            </li>
                                            <li><a href="category.php?page=1">Shirts</a>
                                            </li>
                                            <li><a href="category.php?page=1">Pants</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-4">
                                        <h5>Shoes</h5>
                                        <ul>
                                            <li><a href="category.php?page=1">Trainers</a>
                                            </li>
                                            <li><a href="category.php?page=1">Sandals</a>
                                            </li>
                                            <li><a href="category.php?page=1">Hiking shoes</a>
                                            </li>
                                            <li><a href="category.php?page=1">Casual</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-4">
        ...
        <div class="collapse clearfix" id="search">
            ...
            <form class="navbar-form" role="search" method="POST" action="search_result.php?page=1">
